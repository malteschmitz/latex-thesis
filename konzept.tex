...
Diese Vorlage verwendet das Paket biblatex. Entsprechend gibt es verschiedene Befehle zum Einfügen von Literaturverweisen. Neben dem einfachen Verweis \cite{rltl} gibt es zum Beispiel auch den Verweis unter Nennung der Autoren \textcite{rltl} oder die vollständige Quellenangabe in der Fußnote\footfullcite{rltl}.
